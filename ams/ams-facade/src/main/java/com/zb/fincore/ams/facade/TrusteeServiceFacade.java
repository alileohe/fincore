 ...
 * 版本: V1.0
 */
public interface TrusteeServiceFacade {
     ...
     * @return 创建受托方响应对象
     */
    CreateTrusteeResponse createTrustee(CreateTrusteeRequest req);
     ...
     * @return 分页查询基础响应对象
     */
    PageQueryResponse<TrusteeModel> queryTrusteeList(QueryTrusteeListRequest req);
     ...
     * @return 基础查询响应对象
     */
    QueryResponse<TrusteeModel> queryTrustee(QueryTrusteeRequest req);
}
