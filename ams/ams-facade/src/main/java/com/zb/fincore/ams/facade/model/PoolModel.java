...
public class PoolModel extends BaseModel {
     ...
     * SerialVersionUID
     */
    private static final long serialVersionUID = 6261577092768011560L;
     ...
     * 受托方
     */
    private TrusteeModel trusteeModel;
    ...
    public TrusteeModel getTrusteeModel() {
        return trusteeModel;
    }

    public void setTrusteeModel(TrusteeModel trusteeModel) {
        this.trusteeModel = trusteeModel;
    }
