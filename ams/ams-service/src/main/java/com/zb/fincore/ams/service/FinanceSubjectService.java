...
public interface FinanceSubjectService {
     ...
     * @return 创建融资主体响应对象
     */
    CreateFinanceSubjectResponse createFinanceSubject(@Valid CreateFinanceSubjectRequest req) throws Exception;
     ...
     * @return 分页查询基础响应对象
     */
    PageQueryResponse<FinanceSubjectModel> queryFinanceSubjectList(QueryFinanceSubjectListRequest req) throws Exception;
     ...
     * @return 基础查询响应对象
     */
    QueryResponse<FinanceSubjectModel> queryFinanceSubject(@Valid QueryFinanceSubjectRequest req) throws Exception;
}
