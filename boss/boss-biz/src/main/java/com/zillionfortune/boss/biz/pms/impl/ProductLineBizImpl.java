...
public class ProductLineBizImpl implements ProductLineBiz {
	 ...
	 */
	@Override
	public BaseWebResponse queryProductLineList(QueryProductLineListRequest req) {
		...
		try {
			...
			PageQueryResponse<ProductLineModel>  queryProductLineListResponse= productLineListQueryUseHttp(req);
     ...
     * @throws Exception
     */
    public PageQueryResponse<ProductLineModel> productLineListQueryUseHttp(QueryProductLineListRequest req) throws Exception {
