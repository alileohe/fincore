...
import com.zillionfortune.boss.common.exception.PaycoreException;
...
public class HttpClientUtil {
    ...
    public static void main(String[] args) throws Exception {
    	...
    	//String url= "http://192.168.0.74:8080/trading/userbalanceservice/queryuserbalance.html";
    	/*String url="http://127.0.0.1:8080/operation/operationService/operationLogin.html";
    	String sendData="name=zhansan&password=zhangsan";
    	String json=sendPostRequest(url, sendData, true);
    	System.out.println(json);*/
    	
    	/*String url="http://192.168.0.43:80/t/authorizedpersonservice/authorizedpersonupdateaudit.json";
    	String sendData="memberId=3&status=9";
    	String json=sendPostRequest(url, sendData, true);
    	System.out.println(json);*/
    	
    	
    	String sendDataAuth="status=3&memberId=EM201701161135475103847223";
		
    	String result=HttpClientUtil.sendPostRequest("http://192.168.0.43:80/t/authorizedpersonservice/authorizedpersonupdateaudit.json", sendDataAuth,false);
    ...
    public static String sendPostRequest(String reqURL, String sendData, boolean isEncoder, String encodeCharset,
        ...
        try {
            if (isEncoder) {
                ...
                if(sendData!=null&&!sendData.trim().equals("")){
