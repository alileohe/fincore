...
import com.zb.fincore.pms.service.dal.model.*;
...
public abstract class AbstracProductCacheServiceImpl extends BaseCacheServiceImpl implements ProductCacheService {
     ...
     * 产品缓存集合
     */
    protected static LinkedHashMap<String, ProductModel> PRODUCT_CACHE_MAP = new LinkedHashMap<>();
    ...
    public synchronized BaseResponse refreshProductCache() throws Exception {
        LinkedHashMap<String, ProductModel> productModelMap = new LinkedHashMap<>();
        ...
        if (!CollectionUtils.isEmpty(productList)) {
            ...
            for (Product product : productList) {
                ...
                if (!CollectionUtils.isEmpty(product.getProductContractList())) {
                    List<ProductContractModel> productContractModels = new ArrayList<>();
