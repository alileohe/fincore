...
public class HttpClientUtil {
     ...
     * @return 远程主机响应正文
     */
    public static String sendGetRequest(String reqURL, String decodeCharset) throws CommonException {
        ...
        try {
            ...
            throw new CommonException("9999", "协议错误");
        } catch (ParseException e) {
            log.error(e.getMessage(), e);
            throw new CommonException("9999", e.getMessage());
        } catch (IOException e) {
            log.error("该异常通常是网络原因引起的,如HTTP服务器未启动等,堆栈信息如下", e);
            throw new CommonException("9999", "网络原因");
        } finally {
    ...
    public static String sendPostRequestAes(String reqURL, String sendData) throws Exception {
        String responseContent = null;
        HttpClient httpClient = new DefaultHttpClient();
        HttpPost httpPost = new HttpPost(reqURL);
        httpPost.setHeader(HTTP.CONTENT_TYPE, "application/json");
     ...
     * @return 远程主机响应正文
     */
    public static String sendPostSSLRequestAes(String reqURL, String sendData) {
